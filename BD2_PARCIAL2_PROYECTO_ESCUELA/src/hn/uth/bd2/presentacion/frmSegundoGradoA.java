 ...
 * @author Buddys
 */
public class frmSegundoGradoA extends javax.swing.JInternalFrame {
    ...
    private void listarAlumnos() {
        tablaAlumnos.setModel(this.CONTROL.listarAlumnosGrado("Segundo Grado", "A"));
    ...
    private void listarAlumnosCalif() {
        tablaCalificados.setModel(this.CONTROL.listarAlumnosCalificados("Segundo Grado", "A"));
    ...
    private void cargarCategorias() {
        DefaultComboBoxModel items = this.CONTROL.llenandoProfesores("Segundo Grado", "A");
    ...
    private boolean validarAlumnoCalificado(int idAlumno, int idAsignatura) {
        ...
        listaCalif.addAll(grado.listarCalificados("Segundo Grado", "A"));
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Segundo Grado Seccion A");
