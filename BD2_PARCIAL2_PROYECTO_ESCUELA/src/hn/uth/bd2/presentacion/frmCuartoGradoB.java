 ...
 * @author Buddys
 */
public class frmCuartoGradoB extends javax.swing.JInternalFrame {
    ...
    private void listarAlumnos() {
        tablaAlumnos.setModel(this.CONTROL.listarAlumnosGrado("Cuarto Grado", "B"));
    ...
    private void listarAlumnosCalif() {
        tablaCalificados.setModel(this.CONTROL.listarAlumnosCalificados("Cuarto Grado", "B"));
    ...
    private void cargarCategorias() {
        DefaultComboBoxModel items = this.CONTROL.llenandoProfesores("Cuarto Grado", "B");
    ...
    private boolean validarAlumnoCalificado(int idAlumno, int idAsignatura) {
        ...
        listaCalif.addAll(grado.listarCalificados("Cuarto Grado", "B"));
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cuarto Grado Seccion B");
