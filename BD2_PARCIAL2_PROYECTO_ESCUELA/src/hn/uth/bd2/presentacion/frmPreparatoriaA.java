 ...
 * @author Buddys
 */
public class frmPreparatoriaA extends javax.swing.JInternalFrame {
    ...
    private void listarAlumnos() {
        tablaAlumnos.setModel(this.CONTROL.listarAlumnosGrado("Preparatoria", "A"));
    ...
    private void listarAlumnosCalif() {
        tablaCalificados.setModel(this.CONTROL.listarAlumnosCalificados("Preparatoria", "A"));
    ...
    private boolean validarAlumnoCalificado(int idAlumno, int idAsignatura) {
        ...
        listaCalif.addAll(grado.listarCalificados("Preparatoria", "A"));
