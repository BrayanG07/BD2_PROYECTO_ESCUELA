 ...
 * @author Buddys
 */
public class frmSegundoGradoB extends javax.swing.JInternalFrame {
    ...
    private void listarAlumnos() {
        tablaAlumnos.setModel(this.CONTROL.listarAlumnosGrado("Segundo Grado", "B"));
    ...
    private void listarAlumnosCalif() {
        tablaCalificados.setModel(this.CONTROL.listarAlumnosCalificados("Segundo Grado", "B"));
    ...
    private boolean validarAlumnoCalificado(int idAlumno, int idAsignatura) {
        ...
        listaCalif.addAll(grado.listarCalificados("Segundo Grado", "B"));
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Segundo Grado Seccion B");
