 ...
 * @author Buddys
 */
public class frmTercerGradoB extends javax.swing.JInternalFrame {
    ...
    private void listarAlumnos() {
        tablaAlumnos.setModel(this.CONTROL.listarAlumnosGrado("Tercer Grado", "B"));
    ...
    private void listarAlumnosCalif() {
        tablaCalificados.setModel(this.CONTROL.listarAlumnosCalificados("Tercer Grado", "B"));
    ...
    private void cargarCategorias() {
        DefaultComboBoxModel items = this.CONTROL.llenandoProfesores("Tercer Grado", "B");
    ...
    private boolean validarAlumnoCalificado(int idAlumno, int idAsignatura) {
        ...
        listaCalif.addAll(grado.listarCalificados("Tercer Grado", "B"));
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Tercer Grado Seccion B");
